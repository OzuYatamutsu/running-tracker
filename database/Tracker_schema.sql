--
-- File generated with SQLiteStudio v3.2.1 on Thu Sep 5 14:03:20 2019
--
...
CREATE TABLE activity (
    ...
    wrist               TEXT    NOT NULL
                                DEFAULT '',
    stairs              TEXT    NOT NULL
                                DEFAULT '',
    breathe             TEXT    NOT NULL
                                DEFAULT '',
    standups            TEXT    NOT NULL
                                DEFAULT '',
    backwards           TEXT    NOT NULL
                                DEFAULT (''),
    notes               TEXT    NOT NULL
                                DEFAULT '',
    FOREIGN KEY (
